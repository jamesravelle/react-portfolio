    ...
    return (
        <header>
          <nav className="navbar navbar-expand-lg fixed-top">
            <span className="navbar-brand nav-link"  onClick={()=>props.heroUpdate("Welcome!","100vh","home", true, "#282828")}>James Ravelle</span>
            <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
              <span className="navbar-toggler-icon"></span>
            </button>
            <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div className="navbar-nav">
                <span className="nav-item nav-link" onClick={()=>props.heroUpdate("Welcome!","100vh","home", true, "#282828")}>Home</span>
